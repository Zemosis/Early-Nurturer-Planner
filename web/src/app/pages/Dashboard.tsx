      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 py-6 lg:py-8">
        ...
        <div className="lg:hidden space-y-6">
          ...
          {currentPlan ? (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <span className="text-4xl">{currentPlan.themeEmoji}</span>
                <div className="flex-1">
                  <p className="text-sm text-muted-foreground">This Week's Theme</p>
                  <h3 className="text-xl text-foreground">{currentPlan.theme}</h3>
                  <p className="text-xs text-muted-foreground mt-0.5">Week {currentPlan.weekNumber} • {currentPlan.weekRange}</p>
                </div>
              </div>

              <div className="flex flex-wrap gap-2 mb-4">
                {currentPlan.domains.slice(0, 3).map((domain) => (
                  <span
                    key={domain}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">No plan generated yet</p>
                </div>
              </div>
            ...
            >
              <div>
                <div className="flex items-start gap-4 mb-6">
                  <span className="text-6xl leading-none">{currentPlan.themeEmoji}</span>
                  <div className="flex-1">
                    <p className="text-sm text-muted-foreground mb-1">This Week's Theme</p>
                    <h2 className="text-2xl font-semibold text-foreground mb-1">{currentPlan.theme}</h2>
                    <p className="text-sm text-muted-foreground">Week {currentPlan.weekNumber} • {currentPlan.weekRange}</p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {currentPlan.domains.map((domain) => (
                      <span
                        key={domain}
                ...
                <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 mb-6">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      <p className="text-2xl font-bold text-foreground">{currentPlan.activities.length}</p>
                      <p className="text-xs text-muted-foreground">Activities</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-foreground">{currentPlan.domains.length}</p>
